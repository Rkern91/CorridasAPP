      ...
      return <<<HTML
        <form action="../Controllers/ProcessActionFormController.php" id="form" method="post">
          ...
          <table>
            <tr>
              <th>Nome</th>
              <td style="text-align: left"><input type="text" name="nm_pessoa" id="nm_pessoa" size="30" minlength="2" value="{$nm_pessoa}" oninput="validateInput(this)"></td>
              <th>Dt. Nascimento</th>
              <td style="text-align: left"><input type="date" name="dt_nascimento" id="dt_nascimento" value="{$dt_nascimento}"></td>
            </tr>
            <tr>
              <th>Senha</th>
              <td style="text-align: left"><input type="password" name="ds_senha" id="ds_senha" size="20" minlength="5" value="{$ds_senha}"></td>
              <th>Email</th>
            ...
            <tr>
              <th>Sexo</th>
              <td colspan="3" style="text-align: left"><select name="ds_sexo" id="ds_sexo">{$this->obterOptionsSexo()}</select></td>
            </tr>
            <tr>
              <th>Ação:</th>
              <td colspan="3">
